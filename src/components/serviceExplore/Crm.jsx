...
import heroAnimation from "../../lotties/Crm.json";
...
const stepsLeft = [
  ...
  {
    title: "Define CRM Features & Objectives",
    color: "bg-teal-400",
...
const services = [
  {
    ...
    description:
      "Tailored CRM platforms built to streamline customer management and align with business processes.",
  },
  {
    title: "Cloud-Based CRM",
    img: "https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg",
    description:
      "Scalable, accessible CRM systems hosted in the cloud, enabling remote access and real-time collaboration.",
  },
  {
    title: "Third-Party Integrations",
    img: "https://images.pexels.com/photos/1181359/pexels-photo-1181359.jpeg",
    description:
      "Seamless integration with tools like email, marketing platforms, and support systems for a unified workflow.",
  },
  {
    title: "Workflow Automation",
    img: "https://images.pexels.com/photos/1181615/pexels-photo-1181615.jpeg",
    description:
      "Automate repetitive tasks and customer interactions to improve efficiency and responsiveness.",
  },
  {
    title: "CRM Analytics",
    img: "https://images.pexels.com/photos/1181615/pexels-photo-1181615.jpeg",
    description:
      "Gain insights into customer behavior and campaign performance through advanced analytics and reporting.",
  },
  {
    title: "Maintenance & Support",
    img: "https://images.pexels.com/photos/1181615/pexels-photo-1181615.jpeg",
    description:
      "Ongoing technical support and system updates to ensure uninterrupted performance and growth.",
  },
];
...
export default function Crm() {
  ...
  return (
    <>
      <section className="bg-gradient-to-br from-blue-50 via-white to-[#48C9DA] py-5 md:py-5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg md:text-xl text-gray-700 leading-relaxed max-w-lg mx-auto md:mx-0">
              Customer Relationship Management (CRM) development builds systems
              to manage customer interactions, automate workflows, provide
              analytics, and integrate tools to improve satisfaction and
              retention.
            </p>
      ...
      <section className="bg-blue-50 py-20">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-blue-900 text-lg mb-8">
            Let’s develop a powerful CRM solution that helps your business grow
            stronger connections and improve retention.
          </p>
          <button
